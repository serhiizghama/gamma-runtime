    ...
    <div style={MODAL_OVERLAY} onClick={onCancel}>
      <div style={MODAL_BOX} onClick={(e) => e.stopPropagation()}>
        ...
        <div style={MODAL_ACTIONS}>
          <button type="button" style={BTN} onClick={onCancel}>{cancelLabel}</button>
          <button type="button" style={danger ? BTN_DANGER : BTN} onClick={onConfirm}>
            {confirmLabel}
          </button>
        </div>
      </div>
  ...
  return (
    <div style={MODAL_OVERLAY} onClick={onClose}>
      <div style={MODAL_BOX} onClick={(e) => e.stopPropagation()}>
        ...
        <div style={MODAL_BODY}>{message}</div>
        <div style={MODAL_ACTIONS}>
          <button type="button" style={BTN} onClick={onClose}>OK</button>
        </div>
      </div>
    </div>
  );
